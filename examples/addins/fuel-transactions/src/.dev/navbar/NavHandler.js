class NavHandler {
    ...
    */
    generateContent(){
        ...
        let centerPane            = document.getElementById('runnerDemo');
    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.runnerDemo.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.runnerDemo.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'runnerDemo'){
                    geotab.addin.runnerDemo.blur();
                } else {
                    geotab.addin.runnerDemo.focus(global.api, global.state);
                }
            }
        }, 100);
    }
