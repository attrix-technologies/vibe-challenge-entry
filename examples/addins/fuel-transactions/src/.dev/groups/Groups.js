...
class Groups {
    ...
    resetActiveGroups(){
        ...
        if (name && geotab.addin[name].focus) geotab.addin[name].focus(this.api, this.state);
    }
    ...
    toggleGroupFilter(id){
        ...
        var name = Object.keys(geotab.addin)[0];
        if (name && geotab.addin[name].focus) geotab.addin[name].focus(this.api, global.state);
    }
